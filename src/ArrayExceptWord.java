...
public class ArrayExceptWord {

    private String[] arrExeptWord = {
            "-",	"еще",	"него",	"сказать", "+",
            "а",	"ж",	"нее",	"со",
            "без",	"же",	"ней",	"совсем",
    ...
    public boolean isExceptWord(String str) {

        for (int i = 0; i < arrExeptWord.length; i++){
            if (arrExeptWord[i].equals(str))
                return true;
        }
        return false;
    }
